    ...
    <section className="bg-[#F5F5F7] py-24 px-6 rounded-t-[3rem] -mt-10 relative z-30">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
        <div className="lg:w-1/2">
             ...
             <p className="text-gray-500 text-lg leading-relaxed mb-8">Raw data is useless without context. The Statmize App transforms complex sensor readings into clear, actionable coaching advice.</p>
                ...
                {[
                  ...
                  { t: "Leaderboards", d: "Compete with friends globally.", i: Users },
                   ...
                   <div key={i} className="flex gap-4">
                      <div className="w-12 h-12 bg-black text-white rounded-xl shadow-sm flex items-center justify-center shrink-0"><f.i className="text-white" size={24} /></div>
                      <div><h4 className="font-bold text-gray-900">{f.t}</h4><p className="text-sm text-gray-500">{f.d}</p></div>
                   </div>
                ))}
             </div>
        </div>
        <div className="lg:w-1/2 flex justify-center">
           <div className="relative w-[300px] h-[600px] bg-black rounded-[3rem] shadow-2xl border-8 border-gray-800 overflow-hidden">
              <div className="absolute inset-0 bg-[#121212] flex flex-col items-center justify-center p-6 text-center">
                 <div className="w-20 h-20 bg-gradient-to-tr from-[#A06CD5] to-[#4ADE80] rounded-full flex items-center justify-center mb-6"><Zap className="text-white" size={40} /></div>
